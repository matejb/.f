 ...
 '(elfeed-feeds
   (quote
    (("https://www.goinggo.net/index.xml" golang)
     ...
     ("http://research.swtch.com/feed.atom" golang)
...
(custom-set-faces
 ...
 '(epe-pipeline-delimiter-face ((t (:foreground "steel blue"))))
 '(epe-pipeline-host-face ((t (:foreground "peru"))))
 '(epe-pipeline-time-face ((t (:foreground "deep sky blue"))))
 '(epe-pipeline-user-face ((t (:foreground "tomato")))))
